...
struct TextNode : public ASTNode {
  ...
  TextNode(const std::string_view &text) : ASTNode(NodeType::TEXT), text_(text) {}
};

struct IdNode : public ASTNode {
  std::string_view id_;
  IdNode(const std::string_view &id) : ASTNode(NodeType::ID), id_(id) {}
};
...
struct DefBlockNode : public ASTNode {
  ...
  DefBlockNode(const std::string_view &id, std::vector<std::string_view> &&args, std::vector<std::unique_ptr<ASTNode>> &&macro) 
...
struct BlockNode : public ASTNode {
  ...
  BlockNode(const std::string_view &id, std::vector<std::unique_ptr<ASTNode>> &&args) 
...
struct DefineNode : public ASTNode {
  ...
  DefineNode(const std::string_view &id, const std::string_view &value) : ASTNode(NodeType::DEFINE), id_(id), value_(value) {}
};
